		...
		<input type="hidden" name="module" value="signup">
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="email">에나멜:</label>
						<input type="email" class="form-control" id="email" name="email" required="required">
					</div>
					<div class="form-group">
						<label for="comment">나에 대해서:</label>
						<textarea class="form-control" rows="5" id="comment" name="comment" placeholder="나에 관한 모든 것..." required="required"></textarea>
					</div>
					<button type="submit" class="btn btn-primary btn-block">신청서 제출</button>
				</div>
			</div>
		</form>
	</div>
