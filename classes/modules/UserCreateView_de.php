...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link active" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=usercreate">Create User</a>		
			</li>
			<li class="nav-item">
		...
		<ul class="navbar-nav ml-auto">		
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownlang">
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=usercreate&lang=de"><span class="flag-icon flag-icon-de"> </span>  Deutsch</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=usercreate&lang=us"><span class="flag-icon flag-icon-us"> </span>  English</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=usercreate&lang=kr"><span class="flag-icon flag-icon-kr"> </span>  한국어</a>
				</div>
			</li>		
		</ul>	
	</div>  
...
<section class="container-section">
	<div class="container mb-4">
		<div class="row pb-4">
			<div class="col-sm-12"><h2>New Member und Hauptkonto</h2></div>
		</div>
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
			<input type="hidden" name="module" value="usercreate">
			<input type="hidden" name="userId" value="0">
			<div class="row mb-3">
				<div class="col-sm-4"><h4>Benutzer</h4></div>
				<div class="col-sm-8">
			...
			<div class="row mb-3">			
				<div class="col-sm-4"><h4>Konto</h4></div>
				<div class="col-sm-8">
					<div class="form-group">
...
<section class="container-section">
	<div class="container mb-4">
		<div class="row pb-4">
			<div class="col-sm-12"><h2>Update Member und Hauptkonto</h2></div>
		</div>
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
			...
			<div class="row mb-3">			
				...
				<div class="col-sm-8">					  
					...
					<div class="form-group">
					  ...
					  <div class="custom-file">
						<input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="tokenIcon">
						<label class="custom-file-label" for="inputGroupFile01">Dateiauswahl</label>
					  </div>
					</div>					
				</div>
			</div>
			<button type="submit" class="btn btn-lg btn-outline-primary btn-block mb-1">Absenden</button>			
		</form>		
	</div>
</section>
