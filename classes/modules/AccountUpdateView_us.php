...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=userupdate&userId=<?php echo $data->userId; ?>">Update User</a>		
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=accountsuspend&accountId=<?php echo $accountId; ?>">Suspend Account</a>
			</li>
			<li class="nav-item">
		...
		<ul class="navbar-nav ml-auto">		
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownlang">
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=accountupdate&lang=de&accountId=<?php echo $accountId; ?>"><span class="flag-icon flag-icon-de"> </span>  Deutsch</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=accountupdate&lang=us&accountId=<?php echo $accountId; ?>"><span class="flag-icon flag-icon-us"> </span>  English</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=accountupdate&lang=kr&accountId=<?php echo $accountId; ?>"><span class="flag-icon flag-icon-kr"> </span>  한국어</a>
				</div>
			</li>		
		</ul>	
	</div>  
