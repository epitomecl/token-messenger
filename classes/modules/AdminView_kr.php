...
<section class="container-section">
	<div class="container-fluid mb-4">
		<form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="filter">
			...
			<div class="row pb-4">
			  <div class="col-sm-5"><h2>회원 계정</h2></div>
			  <div class="col-sm-7">
					...
					<div class="col-sm-4">			
						<div class="form-check mb-2 mr-sm-2">
							<label class="form-check-label">
								<input class="form-check-input" type="checkbox" id="suspended" name="suspended" value="1" <?php echo ($suspended == 1) ? "checked=\"checked\"": ""; ?>> 매달린 뿐
							</label>
						</div>		
					</div>	
					<div class="col-sm-4">
						<label for="searchText" class="mr-sm-2">검색 텍스트:</label>
						<input type="text" class="form-control mb-2 mr-sm-2" id="searchText" name="searchText"  value="<?php echo $searchText; ?>">
					</div>	
					<div class="col-sm-4">			
						<label for="tokenName" class="mr-sm-2">토큰 이름:</label>
							...
							<tr class="m-0 d-flex">
								...
								<td class="col">
									<form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
										...
										<button type="submit" data-transactionid="<?php echo intval($row["accountId"]); ?>" class="btn btn-outline-secondary">세부</button>
									</form>	
								</td>
							</tr>
						<?php endforeach; ?>
