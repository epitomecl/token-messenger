...
<section class="container-section bg-light">
	...
	<div class="container-fluid viewUserAccount mb-4">
		...
		<div class="card-footer">이 계정은 정지되었습니다. 자체 독특한 토큰이 생성되지 않습니다.</div>
		<?php endif; ?>
		</div>
		<?php endforeach; ?>
		</div>
		...
		<div class="card-footer ${display}">이 계정은 정지되었습니다. 자체 독특한 토큰이 생성되지 않습니다.</div>
		</div>
		</template>
	</div>
</section>
...
$('#textarea-1,#textarea-2,#textarea-3').EnsureMaxLength({separator: ' 중 ', limit: 512});
