...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link active" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=userprofile">My Profile</a>		
			</li>
			<?php if ($isMember): ?>
			<li class="nav-item">
		...
		<ul class="navbar-nav ml-auto">		
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownlang">
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=userprofile&lang=de"><span class="flag-icon flag-icon-de"> </span>  Deutsch</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=userprofile&lang=us"><span class="flag-icon flag-icon-us"> </span>  English</a>
					<a class="dropdown-item" href="<?php echo $_SERVER['PHP_SELF']; ?>?module=userprofile&lang=kr"><span class="flag-icon flag-icon-kr"> </span>  한국어</a>
				</div>
			</li>		
		</ul>	
	</div>  
...
<section class="container-section">
	<div class="container mb-4">
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
			<input type="hidden" name="module" value="userprofile">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="comment">Selbstbeschreibung:</label>
						<textarea class="form-control" rows="5" id="comment" name="comment" placeholder="Meine Vorlieben..."><?php echo $data->comment; ?></textarea>
					</div>
					<div class="form-group">
			...
			<button type="submit" class="btn btn-lg btn-outline-primary btn-block mb-1">Speichern</button>			
		</form>		
	</div>
</section>
